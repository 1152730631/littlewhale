(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["components/verticalTab/index"],{

/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/components/verticalTab/index.tsx?taro&type=script&parse=COMPONENT&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/components/verticalTab/index.tsx?taro&type=script&parse=COMPONENT& ***!
  \*****************************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.scss */ "./src/components/verticalTab/index.scss");
...
var ClVerticalTab = function (_Taro$Component) {
  _inherits(ClVerticalTab, _Taro$Component);

  function ClVerticalTab() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, ClVerticalTab);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ClVerticalTab.__proto__ || Object.getPrototypeOf(ClVerticalTab)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "anonymousState__temp3", "anonymousState__temp4", "anonymousState__temp5", "loopArray84", "current", "tabs", "scrollId", "isAliPay", "undefined", "scrollContent", "props", "verticalNavTop", "screenPercent", "isH5", "children"], _this.anonymousFunc0Map = {}, _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(ClVerticalTab, [{
    key: "_constructor",
    value: function _constructor(props) {
      _get(ClVerticalTab.prototype.__proto__ || Object.getPrototypeOf(ClVerticalTab.prototype), "_constructor", this).call(this, props);
    ...
    value: function _createData() {
      ...
      var _useState = (0, _taroWeapp.useState)(props.tabs || []),
      ...
      var _useState3 = (0, _taroWeapp.useState)(currentId),
          _useState4 = _slicedToArray(_useState3, 2),
          current = _useState4[0],
          setCurrent = _useState4[1];

      var _useState5 = (0, _taroWeapp.useState)(tabsState.findIndex(function (item) {
        return item.name === props.tabs[0].name;
      })),
          _useState6 = _slicedToArray(_useState5, 2),
          verticalNavTop = _useState6[0],
          setVerticalNavTop = _useState6[1];

      var _useState7 = (0, _taroWeapp.useState)(currentId),
          _useState8 = _slicedToArray(_useState7, 2),
          scrollId = _useState8[0],
          setScrollId = _useState8[1];

      var _useState9 = (0, _taroWeapp.useState)(0),
          _useState10 = _slicedToArray(_useState9, 2),
          scrollContent = _useState10[0],
          setScrollContent = _useState10[1];

      var _useState11 = (0, _taroWeapp.useState)(false),
          _useState12 = _slicedToArray(_useState11, 2),
          clickTab = _useState12[0],
          setClickTab = _useState12[1];

      (0, _taroWeapp.useEffect)(function () {
        var list = props.tabs || [];
        setTabsState(list.map(function (item) {
          item.cu_vertical_tab_id = (0, _index.generateId)();
          return item;
        }));
      }, [props.tabs]);
      var tabs = tabsState || [];
      ...
      var onH5Scroll = function onH5Scroll(e) {
        if (clickTab) {
          return;
        }if (scrollTimer) {
      ...
      var changeTop = function changeTop(id) {
        var query = _taroWeapp2.default.createSelectorQuery();
        ...
        new Promise(function (resolve) {
          ...
          new Promise(function (resolve) {
            view.boundingClientRect().exec(function (res) {
              var data = res[(0, _index.getRectNumber)()];
              setTimeout(function () {
      ...
      var anonymousState__temp = (0, _taroWeapp.internal_inline_style)({
        height: props.height === "full" ? "100%" : (0, _taroWeapp.pxTransform)(props.height),
        maxHeight: "100vh",
        width: "100%"
      });
      this.anonymousFunc1 = onScroll;
      var anonymousState__temp2 = (0, _taroWeapp.internal_inline_style)({
        height: props.height === "full" ? "100%" : (0, _taroWeapp.pxTransform)(props.height),
        maxHeight: "100vh",
        width: "100%"
      });
      this.anonymousFunc2 = onH5Scroll;
      var anonymousState__temp3 = (0, _index.classNames)("flex", props.className);
      ...
      var loopArray84 = tabs.map(function (item, __index0) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey = "bifzz" + __index0;

        _this2.anonymousFunc0Map[_$indexKey] = function () {
          id = item.$original.id;
          scrollTab = true;
          changeTop(id);
          setCurrent(item.$original.id);
          setVerticalNavTop(tabs.findIndex(function (tab) {
            return tab.name === item.$original.name;
          }));
          setClickTab(true);
          !isH5 && setScrollId(item.$original.id);
          setTimeout(function () {
            setClickTab(false);
          }, 800);
        };
      ...
      Object.assign(this.__state, {
        ...
        tabs: tabs,
        scrollId: scrollId,
        isAliPay: _index.isAliPay,
        undefined: undefined,
        scrollContent: scrollContent,
        props: props,
        verticalNavTop: verticalNavTop,
        screenPercent: _index.screenPercent,
        isH5: isH5
      });
      return this.__state;
    }
  ...
  return ClVerticalTab;
}(_taroWeapp2.default.Component);

ClVerticalTab.$$events = ["anonymousFunc0", "anonymousFunc1", "anonymousFunc2"];
ClVerticalTab.$$componentPath = "components/verticalTab/index";
...
exports.default = ClVerticalTab;

Component(__webpack_require__(/*! @tarojs/taro-weapp */ "./node_modules/@tarojs/taro-weapp/index.js").default.createComponent(ClVerticalTab));

/***/ }),

/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/jinbai/Documents/github/mp-colorui/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/components/verticalTab/index.tsx?taro&type=template&parse=COMPONENT&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=/Users/jinbai/Documents/github/mp-colorui/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/components/verticalTab/index.tsx?taro&type=template&parse=COMPONENT& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "components/verticalTab/index.wxml";
...
/* harmony import */ var _index_tsx_taro_type_template_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.tsx?taro&type=template&parse=COMPONENT& */ "./src/components/verticalTab/index.tsx?taro&type=template&parse=COMPONENT&");
/* harmony import */ var _index_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.tsx?taro&type=script&parse=COMPONENT& */ "./src/components/verticalTab/index.tsx?taro&type=script&parse=COMPONENT&");
...
/***/ "./src/components/verticalTab/index.tsx?taro&type=script&parse=COMPONENT&":
/*!********************************************************************************!*\
  !*** ./src/components/verticalTab/index.tsx?taro&type=script&parse=COMPONENT& ***!
  \********************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_tarojs_mini_runner_dist_loaders_wxTransformerLoader_js_ref_6_0_index_tsx_taro_type_script_parse_COMPONENT___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./index.tsx?taro&type=script&parse=COMPONENT& */ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/components/verticalTab/index.tsx?taro&type=script&parse=COMPONENT&");
...
/***/ "./src/components/verticalTab/index.tsx?taro&type=template&parse=COMPONENT&":
/*!**********************************************************************************!*\
  !*** ./src/components/verticalTab/index.tsx?taro&type=template&parse=COMPONENT& ***!
  \**********************************************************************************/
/*! no static exports found */
...
},[["./src/components/verticalTab/index.tsx","runtime","taro","vendors","common"]]]);