...
export default class ClButton extends Taro.Component {
  render() {
    ...
    const onGetRealnameAuthInfo = e => {
      !props.disabled && props.onGetRealnameAuthInfo && props.onGetRealnameAuthInfo(e);
    };
    const onError = e => {
    ...
    const normalButton = <Button className={classNames(`${buttonClassName} ${disabledClassName ? "disabled" : ""}`)}
    ...
    const longButton = <View className={classNames("flex flex-direction", props.className)} style={Object.assign({}, props.style)}>
      {normalButton}
    </View>;
    return props.long ? longButton : <View className={classNames(props.className)} style={Object.assign({ display: "inline-block" }, props.style)}>
      {normalButton}
    </View>;
  }
