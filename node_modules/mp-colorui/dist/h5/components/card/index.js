...
export default class ClCard extends Taro.Component {
  render() {
    ...
    return <View className={classNames([`cu-card case ${typeClassName}`], props.className)} style={Object.assign({}, props.style)}>
      <View className={classNames(["cu-item", {
        shadow: props.shadow
      }, colorClassName, {
        cu_card_active: props.active
      }])}>
        {props.title && props.title.text ? <View className="cu_card__title-line padding">
            <ClText {...props.title} />
          </View> : ""}
