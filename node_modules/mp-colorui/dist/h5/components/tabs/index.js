...
import "./index.scss";
import { classNames, getRectNumber, isAliPay, screenPercent } from "../../lib/index";
let move = 0;
...
export default class ClTabs extends Taro.Component {
  ...
  render() {
    ...
    return <View className={classNames(this.props.className)} style={Object.assign({ overflow: "hidden" }, this.props.style)}>
        {renderComponent()}
        <ScrollView scrollY>
