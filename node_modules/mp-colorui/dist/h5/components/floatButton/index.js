...
export default class ClFloatButton extends Taro.Component {
  render() {
    ...
    return <View className={classNames(`${show ? "float_button__mask" : ""}`, props.className)} style={Object.assign({}, props.style)} onClick={() => {
      closeWithShadow && clickButton();
    }}>
      <View className="float_button__fixed" style={{
        top: position.top && position.top !== "auto" ? Taro.pxTransform(position.top) : "auto",
        right: position.right && position.right !== "auto" ? Taro.pxTransform(position.right) : "auto",
        bottom: position.bottom && position.bottom !== "auto" ? Taro.pxTransform(position.bottom) : "auto",
        left: position.left && position.left !== "auto" ? Taro.pxTransform(position.left) : "auto"
